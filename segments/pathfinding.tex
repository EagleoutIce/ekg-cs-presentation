...
\foreach[count=\i from 6] \n in {e,e,e,d,d,d,,e,i,i,,a,c,h,i,,,j,g,,a,j,,j,f}{
   \ifx!\n!\else
      \On<\i>{\n}{queue}
   \fi
}
...
\On<28>{a}{current}\On<29->{a}{visited}
\On<29-30>{g}{current}\On<31->{g}{visited}
\On<31->{j}{current}% \On<32->{g}{visited}
\scope[@scale]
% "Lauflängenkompression" could have been helpful xD
\node[dot,a] (a) at (0,0)  {\Node{a}{3-16/\infty,17-/17.5}{3-16/\n,17-/e}};
\node[dot,b] (b) at (0,-2) {\Node{b}{3-4/\infty,5-/0}{3-/\n}};
\node[dot,c] (c) at (2,1)  {\Node{c}{3-17/\infty,18-/13}{3-17/\n,18-/e}};
...
\draw (i) -- (j) node[right,k] {6};
\only<32->{ \draw[-Circle,thick,black] (j) -- (h); }
\only<33->{ \draw[-Circle,thick,black] (h) -- (e); }
\only<34->{ \draw[-Circle,thick,black] (e) -- (b); }
\endscope
\endpgfonlayer
\endscope
\only<1->{
...
\begin{tikzpicture}[@O]
   ...
   沁水湾
   \end{CJK*},}~~\href{https://creativecommons.org/licenses/by-sa/4.0/deed.en}{\ccbysa}};
   \tikzset{dot/.style={minimum size=3mm,circle,fill=black,}}
   \PlaceAt{a}{.5}{.5}{e}
   \PlaceAt{b}{.8}{.75}{i}
   \PlaceAt{c}{.55}{.175}{b}
   \PlaceAt{d}{.25}{.15}{a}
...
\begin{frame}{}
\begin{tikzpicture}[@O]
   \node[align=left,font=\scriptsize] at(current page.center) {%
\mark{Eingabe:} Graph \(G = (V, E)\), Start- und Endknoten \(s, e \subseteq V\)\bigskip\\
...
\null\qquad \(u \gets \text{Wähle}~v\) mit minimalen \(v.\text{Kosten}\) aus \(Q\)\smallskip\\
